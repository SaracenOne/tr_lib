...
static String get_tr3_type_info_name(uint32_t p_type_info_id) {
	...
	case 4:
		return "Lara Desert Eagle Animations";
	case 5:
		return "Lara Uzis Animations";
	case 6:
		return "Lara MP5 Animations";
	case 7:
		return "Lara Rocket Launcher Animations";
	case 8:
...
static String get_tr3_animation_name(size_t p_type_info_id, size_t p_animation_id, bool p_using_auxiliary_animation) {
	switch (p_type_info_id) {
		case 0: {
			return get_lara_animation_name(p_animation_id, TR3_PC, p_using_auxiliary_animation);
		} break;
	}
